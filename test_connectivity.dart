...
void main() async {
  ...
  try {
    ...
    _logger.info('Note: Registry changes require administrator privileges to take effect.');
    _logger.info('Run this script as administrator to test the actual registry modifications.');
